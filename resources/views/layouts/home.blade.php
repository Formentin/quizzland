...
<head>
    ...
    <link rel="stylesheet" href="css/aplication-logo.css">
    <link rel="stylesheet" href="css/index.css">
    <link rel="stylesheet" href="css/tagStyles/btn-styles.css">
    <link rel="stylesheet" href="css/main.css">
    <title>QuizzLand</title>
    <style>
...
<body>
    <header>
        ...
        <span class="title">
            <h1 style="font-size: 34px; font-family: 'Neucha', cursive;">QuizzLand</h1>
            <p style="font-size: 14px;"> Aprender é viver!</p>
        </span>
        <nav>
            <a href="/Questions/create">Criar quizz</a>
            <a href="/Community/Community_view">Comunidade</a>
            <a href="/Events">Eventos</a>
            <a href="/Game/gameView">Jogar</a>
        ...
        @if(Auth::check())
            <div class="user-info">
                <span class="user-information span">
                    <h4>{{Auth::User()->name}}</h4>{{--Resgata nome do usuario logago--}}
                    <button>
                        <img src="" alt="">
                    </button>
                </span>
        ...
        @else
            <div class="login_register no_user">
